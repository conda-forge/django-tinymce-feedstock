...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-tinymce-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15130&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-tinymce-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-tinymce` can be installed with:

```
conda install django-tinymce
```

It is possible to list all of the versions of `django-tinymce` available on your platform with:
